...
export default function EventLanding() {
 ...
 className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl bg-dusty-pink text-white border border-border-subtle shadow-card hover:shadow-card text-charcoal dark:text-gray-100 font-bold transition-all">
 ...
 <div className={`aspect-[3/4] flex items-center justify-center ${['bg-rose-200 dark:bg-rose-900/50', 'bg-blue-200', 'bg-green-200', 'bg-yellow-200'][i % 4]}`}>
