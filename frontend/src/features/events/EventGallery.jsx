...
export default function EventGallery() {
 ...
 <div className="bg-rose-50 dark:bg-rose-950/30 border-b-2 border-soft-gray dark:border-gray-800 py-6 px-6">
 ...
 <Link to={`/events/${slug}/booth`} className="inline-block mt-4 px-5 py-2 rounded-lg bg-dusty-pink text-white border border-border-subtle shadow-card hover:bg-deep-rose hover:shadow-card-hover font-bold text-sm transition-all">
 Mulai Foto
 </Link>
 </div>
 </div>
