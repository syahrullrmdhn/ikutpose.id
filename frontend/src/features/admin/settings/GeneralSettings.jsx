...
export default function GeneralSettings() {
 ...
 <h3 className="text-sm font-bold text-neutral-800">General</h3>
 <div>
 <label className="block text-sm font-medium text-neutral-600 mb-1.5">Nama Situs</label>
 ...
 <div>
 <label className="block text-sm font-medium text-neutral-600 mb-1.5">Tagline</label>
 ...
 <Card className="p-5 space-y-4">
 <h3 className="text-sm font-bold text-neutral-800">Booth Defaults</h3>
 ...
 <div>
 <label className="block text-sm font-medium text-neutral-600 mb-1.5">Max Foto/Sesi</label>
 ...
 <Card className="p-5 space-y-4">
 <h3 className="text-sm font-bold text-neutral-800">Storage</h3>
 <div>
 <label className="block text-sm font-medium text-neutral-600 mb-1.5">Storage Driver</label>
 ...
 <div className="grid grid-cols-2 gap-3">
 <div>
 <label className="block text-sm font-medium text-neutral-600 mb-1.5">Retensi Foto (hari)</label>
 <input type="number" value={settings.photo_retention_days} onChange={(e) => update('photo_retention_days', Number(e.target.value))}
 className="w-full px-4 py-2.5 rounded-xl border border-neutral-200 text-sm focus:outline-none focus:border-primary-400" />
 </div>
 <div>
 <label className="block text-sm font-medium text-neutral-600 mb-1.5">Max Upload (MB)</label>
