...
export default function Dashboard() {
 ...
 <div className="h-7 w-16 bg-neutral-100 rounded mb-1" />
 ...
 <Card className="p-5">
 <h3 className="text-base font-bold text-neutral-800 mb-4">Foto per Hari</h3>
 <LineChart data={lineData} labels={lineLabels} height={200} />
 </Card>
 <Card className="p-5">
 <h3 className="text-base font-bold text-neutral-800 mb-4">Template Populer</h3>
 ...
 <h3 className="text-base font-bold text-neutral-800">Foto Terbaru</h3>
 ...
 <div>
 <p className="text-sm font-medium text-neutral-800">{photo.event ?? 'Photo'}</p>
 <p className="text-xs text-neutral-400">{photo.template ?? '-'}</p>
 </div>
 </div>
 <span className="text-xs text-neutral-400">{photo.created_at}</span>
 </div>
 ))}
 {(!stats?.recent_photos || stats.recent_photos.length === 0) && (
 <div className="px-5 py-8 text-center text-sm text-neutral-400">Belum ada foto</div>
 )}
 </div>
 </Card>
 ...
 <div className="p-5 border-b border-neutral-200 flex items-center justify-between">
 <h3 className="text-base font-bold text-neutral-800">Event Mendatang</h3>
 ...
 <p className="text-xs text-neutral-400 mt-0.5">{event.start_date}</p>
 </div>
 ))}
 {(!stats?.upcoming_events || stats.upcoming_events.length === 0) && (
 <div className="px-5 py-8 text-center text-sm text-neutral-400">Tidak ada event</div>
 )}
 </div>
 </Card>
 </div>
