...
export default function PublicGallery() {
 ...
 <div className="relative overflow-hidden bg-rose-50 border-b-2 border-soft-gray">
 ...
 <p className="text-slate-600 font-medium">Koleksi momen dari berbagai event</p>
 </div>
 </div>
 ...
 <p className="text-warm-gray font-medium">Belum ada foto di gallery</p>
 </div>
 </div>
 ) : (
 <div className="columns-2 md:columns-3 lg:columns-4 gap-4 space-y-4">
 ...
 <button className="w-8 h-8 rounded-lg bg-white border border-border-subtle shadow-card flex items-center justify-center text-charcoal"><Heart size={14} /></button>
 </div>
 <div>
 <p className="text-white text-sm font-bold">{photo.photo_session?.event?.name ?? 'Photo'}</p>
 <div className="flex gap-2 mt-2">
 <button className="w-8 h-8 rounded-lg bg-white border border-border-subtle shadow-card flex items-center justify-center text-charcoal"><Download size={14} /></button>
 <button className="w-8 h-8 rounded-lg bg-white border border-border-subtle shadow-card flex items-center justify-center text-charcoal"><Share2 size={14} /></button>
 </div>
 </div>
 </div>
 </motion.div>
 ...
 <motion.div className="relative max-w-lg w-full bg-white rounded-xl border border-border-subtle shadow-card overflow-hidden" initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} onClick={(e) => e.stopPropagation()}>
 <div className="aspect-[3/4] bg-gradient-to-br from-rose-200 via-rose-100 to-white" />
 <div className="p-5">
 <p className="font-bold text-charcoal">{selectedPhoto.photo_session?.event?.name ?? 'Photo'}</p>
 <div className="flex gap-3 mt-4">
 <button className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl bg-dusty-pink text-white border border-border-subtle shadow-card hover:shadow-card text-charcoal font-bold text-sm transition-all"><Download size={16} />Download</button>
 <button className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl bg-white border border-border-subtle shadow-card hover:shadow-card text-charcoal font-bold text-sm transition-all"><Share2 size={16} />Share</button>
 </div>
 </div>
 </motion.div>
 </div>
