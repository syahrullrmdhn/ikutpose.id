...
import { Sliders, Sticker, Type, Undo2, Redo2, Check } from 'lucide-react'
...
export default function PhotoEditor() {
 const { photos, selectedTemplate, appliedFilter, setFilter, appliedStickers, addSticker, updateSticker, removeSticker, setStep } =
 useBoothStore()
 ...
 {template?.name} &middot; {canvasW}×{canvasH}px &middot; {photos.length} foto
 </p>
 </div>
