...
export default function RegisterPage() {
 ...
 <h1 className="text-xl font-extrabold text-charcoal">Buat Akun Baru</h1>
 <p className="text-sm text-warm-gray font-medium mt-1">
 Sudah punya akun?{' '}
 <Link to="/login" className="font-bold text-charcoal hover:text-rose-500 transition-colors">Masuk</Link>
 </p>
 </div>
